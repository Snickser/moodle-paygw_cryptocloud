...
$string['gatewaydescription'] = 'CryptoCloud — авторизованный платежный шлюз для обработки транзакций по кредитным картам.';
...
$string['callback_help'] = 'Скопируйте эту строку и вставьте в "HTTP-уведомления" в настройках магазина в CryptoCloud, и включите там уведомления "payment.succeeded".';
...
$string['cryptocloud'] = 'CryptoCloud (все доступные)';
